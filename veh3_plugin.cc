#ifndef _VEHICLE_PLUGIN2_
#define _VEHICLE_PLUGIN2_
...
namespace gazebo{
	...
	class VehiclePlugin2: public ModelPlugin{
		public: VehiclePlugin2(){}
		...
		public: virtual void Load(physics::ModelPtr _model2, sdf::ElementPtr _sdf){
			...
			this->updateConnection = event::Events::ConnectWorldUpdateBegin(
				std::bind(&VehiclePlugin2::OnUpdate, this));
		...
		public:void OnUpdate(){
			...
			std::ofstream myfile;
			myfile.open("state3.txt",std::ios_base::app);
			common::Time time;
			...
			// std::string line;
			// std::istream::getline(ofile, line);
		...
		public: double speedy=10, speedx=0,accy=0.2;
		public: double self_v=10,self_acc=0.2;
		...
		private: void OnMsg(ConstVector3dPtr &_msg)
		{
			...
			std::string result = "";
		    std::ifstream fin("./build/state.txt");
	        ...
	        std::string state3 = "";
		    std::ifstream fin2("./build/state3.txt");
		    // std::cout << "final line length: " ;
		    if(fin2.is_open()) {
	...
	GZ_REGISTER_MODEL_PLUGIN(VehiclePlugin2);
}
#endif